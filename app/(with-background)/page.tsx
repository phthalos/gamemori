...
export default function Home() {
    return (
        <>
            <Button variant="outline" size="sm" className="z-5 rounded-full text-neutral-200 mb-2 flex gap-1">
            ...
            {/* <span className="text-neutral-200 border rounded-full px-3 py-1 text-sm"> +50만개 게임 데이터 제공</span> */}
            <p
            ...
            <ButtonStart
                href="/personalize"
                className="flex items-center px-7 py-4 text-md font-bold shadow-lg hover:shadow-xl relative gap-1 mb-16"
            >
                테스트 시작하기
